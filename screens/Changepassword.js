...
const Changepassword = ({ isVisible, onClose, ID }) => {
  ...
  //         body: JSON.stringify({
  //           //email: email,
  //           userID: ID, // Replace with the actual firstname
  ...
  //     try {
  //       const response = await fetch(
  //         'http://35.154.235.224:8000/update-password-userid',
  //         requestOptions
  //       );
  ...
  //     Toast.show({
  //       type: 'error',
  //       text1: `New password and confirm password should be the same`,
  //     });
  //     setcurrentPassword('');
  //     setConfirmPassword('');
  //     setnewPassword('');
  ...
  const updatepassword = async () => {
    ...
    if (newPassword === confirmPassword) {
      ...
      fetch("http://35.154.235.224:8000/update-password-userid", requestOptions)
        .then((response) => response.json())
        .then((result) => {console.log(result); result.message? Toast.show({
          type: "success",
    ...
    <View>
      ...
      >
        <Card style={styles.cardContainer4}>
          <Text style={styles.conform}>Update Password</Text>
          ...
          <View style={styles.buttons}>
            <View style={styles.button1}>
              <Button onPress={updatepassword} labelStyle={styles.buttonText}>
                Update
              </Button>
            </View>
